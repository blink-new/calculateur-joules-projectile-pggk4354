...
/// Version compatible Mono pour Ubuntu
/// </summary>
public class CalculateurJoulesMono
{
    ...
    private static void AfficherResultats(double grains, double poidsGrammes, double vitesse, double energie)
    {
        ...
        // Résultat principal
        Console.ForegroundColor = ConsoleColor.Green;
        Console.WriteLine("🎯 ÉNERGIE CINÉTIQUE: " + energie.ToString("F2") + " JOULES");
        Console.ResetColor();
        Console.WriteLine();
        
        // Détails du calcul
        Console.WriteLine("📋 Paramètres utilisés:");
        Console.WriteLine("   • Grains de poudre: " + grains.ToString("F1"));
        Console.WriteLine("   • Poids de la balle: " + poidsGrammes.ToString("F1") + " g (" + (poidsGrammes/1000).ToString("F4") + " kg)");
        Console.WriteLine("   • Vitesse: " + vitesse.ToString("F1") + " m/s");
        Console.WriteLine();
        ...
        Console.WriteLine("   E = 0.5 × " + (poidsGrammes/1000).ToString("F4") + " kg × (" + vitesse.ToString("F1") + " m/s)²");
        Console.WriteLine("   E = 0.5 × " + (poidsGrammes/1000).ToString("F4") + " × " + Math.Pow(vitesse, 2).ToString("F2"));
        Console.WriteLine("   E = " + energie.ToString("F2") + " Joules");
        Console.ResetColor();
        Console.WriteLine();
    ...
    private static void AfficherClassificationEnergie(double energie)
    {
        ...
        Console.WriteLine("   ➤ " + classification + " (" + energie.ToString("F2") + " J)");
        Console.ResetColor();
        Console.WriteLine();
    }
    ...
    private static bool DemanderContinuer()
    {
        ...
        if (reponse != null) reponse = reponse.Trim().ToLower();
        Console.ResetColor();
